...
_C.NAV_VIS.ENABLE_TEXTURE_TOPDOWN = False
_C.NAV_VIS.SAVE_MOSAIC = True
_C.NAV_VIS.TEXTURE_CACHE_DIR = "cache/topdown_texture"
_C.NAV_VIS.TEXTURE_RESOLUTION = 2048
_C.NAV_VIS.TEXTURE_CAMERA_HEIGHT = 8.0
_C.NAV_VIS.TEXTURE_BLACK_FALLBACK = True
_C.NAV_VIS.TEXTURE_BLACK_THRESHOLD = 15
_C.NAV_VIS.TEXTURE_FLOOR_SNAP = 0.25
_C.NAV_VIS.TEXTURE_TRAJECTORY_MARGIN_M = 5.0
_C.NAV_VIS.TEXTURE_WHITE_THRESHOLD = 235
_C.NAV_VIS.TEXTURE_GEOMETRY_BASE = False
_C.NAV_VIS.TEXTURE_WHITE_BACKGROUND = True
